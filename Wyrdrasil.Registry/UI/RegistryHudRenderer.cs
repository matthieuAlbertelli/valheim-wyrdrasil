...
public sealed class RegistryHudRenderer
{
        ...
        int residentCount)
    {
        ...
        var panelRect = new Rect(20f, 180f, 740f, 310f);
        ...
        GUI.Label(new Rect(35f, 242f, 660f, 20f), $"Catégorie : {FormatCategory(state.SelectedCategory)}", _textStyle!);
        GUI.Label(new Rect(35f, 266f, 680f, 20f), $"Action : {FormatAction(state.SelectedAction)}", _textStyle!);
        ...
        GUI.Label(new Rect(35f, 434f, 660f, 20f), "Astuce : vise une chaise, un banc ou un tabouret pour le désigner comme siège.", _hintStyle!);
        GUI.Label(
            new Rect(35f, 458f, 680f, 20f),
