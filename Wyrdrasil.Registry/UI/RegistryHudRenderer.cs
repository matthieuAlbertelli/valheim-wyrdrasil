...
public sealed class RegistryHudRenderer
{
    ...
    private static string FormatAction(RegistryActionType action) => action switch
    {
        ...
        RegistryActionType.EditTargetCraftStationAnchor => "Diagnostic : éditer la pose canonique du poste d'artisanat visé",
        RegistryActionType.ProbeAssignedCraftStationOccupation => "Diagnostic : snapper le résident assigné au poste d'artisanat visé",
