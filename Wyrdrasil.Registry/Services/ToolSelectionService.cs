...
public sealed class ToolSelectionService
{
    ...
    private static readonly RegistryActionType[] ConstructionActions =
    {
        ...
        RegistryActionType.AssignTargetCraftStationToConstructionProject,
        RegistryActionType.AssignTargetResidentToLatestConstructionProject,
        RegistryActionType.ClearTargetResidentConstructionAssignment,
    ...
    public ToolSelectionService(RegistryToolState state)
    {
        _state = state;
