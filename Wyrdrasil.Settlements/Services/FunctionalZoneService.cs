...
public sealed class FunctionalZoneService
{
    ...
    public FunctionalZoneService(ManualLogSource log, RegistryModeService modeService, BuildingService buildingService)
    {
        _log = log;
