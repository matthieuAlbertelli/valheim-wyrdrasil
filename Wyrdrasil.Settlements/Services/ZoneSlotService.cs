...
public sealed class ZoneSlotService
{
    ...
    public ZoneSlotService(ManualLogSource log, RegistryModeService modeService, FunctionalZoneService zoneService, ZonePlacementPolicyService anchorPolicyService)
    {
        _log = log;
