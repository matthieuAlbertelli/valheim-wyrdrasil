...
public sealed class NavigationWaypointService
{
    ...
    public NavigationWaypointService(ManualLogSource log, RegistryModeService modeService, FunctionalZoneService zoneService)
    {
        _log = log;
