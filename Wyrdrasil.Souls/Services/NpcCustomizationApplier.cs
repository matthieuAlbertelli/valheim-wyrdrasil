...
/// </summary>
public sealed class NpcCustomizationApplier
{
    private readonly ManualLogSource _log;

    public NpcCustomizationApplier(ManualLogSource log)
    {
        _log = log;
    }
    ...
    public void Apply(GameObject runtimeObject, VikingIdentityData identity)
    {
        ...
        var report = NpcVisualStateWriter.Apply(runtimeObject, identity, _log);
