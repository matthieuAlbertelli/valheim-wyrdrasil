...
{
    private readonly RegistryNpcAppearanceGenerator _appearanceGenerator;
    private readonly RegistryNpcEquipmentGenerator _equipmentGenerator;
    private int _nextSeed = System.Environment.TickCount;

    public RegistryNpcIdentityGenerator(
        RegistryNpcAppearanceGenerator appearanceGenerator,
        RegistryNpcEquipmentGenerator equipmentGenerator)
    {
