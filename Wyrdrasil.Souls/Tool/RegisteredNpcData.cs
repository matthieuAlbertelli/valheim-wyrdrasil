...
public sealed class RegisteredNpcData
{
    ...
    public int? AssignedCraftStationId => TryGetAssignedTargetId(ResidentAssignmentPurpose.Work, OccupationTargetKind.CraftStation, out var craftStationId)
        ? craftStationId
        : (int?)null;
    public int? AssignedConstructionWorkPostId => TryGetAssignedTargetId(ResidentAssignmentPurpose.Work, OccupationTargetKind.ConstructionWorkPost, out var workPostId)
        ? workPostId
        : (int?)null;
    ...
    public void AssignConstructionWorkPost(int workPostId) => SetAssignment(ResidentAssignmentPurpose.Work, new OccupationTargetRef(OccupationTargetKind.ConstructionWorkPost, workPostId));
